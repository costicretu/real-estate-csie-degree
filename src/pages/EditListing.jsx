    ...
    <>
      ...
      <form onSubmit={onSubmit}>
        <div className="text-center">
          <button type="submit" className='mb-3 mt-5 px-7 py-3 bg-red-500 text-gray-100 font-medium text-sm uppercase rounded-lg w-[200px] shadow-md hover:bg-red-600 hover:shadow-lg focus:bg-red-700 focus:shadow-lg active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out'>Editează anunț</button>
        </div>
      </form>
      {/* <main className='max-w-md px-2 mx-auto'>
        <h1 className='text-3xl text-center mt-6 font-bold'>Editează-ți anunțul</h1>
        <form onSubmit={onSubmit}>
          <p className='text-lg mt-6 font-semibold'>Tip proprietate</p>
          <select value={propertyType} disabled onChange={onChange} className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600' id="property" name="property">
            <option value="apartment">Apartament</option>
            <option value="house">Casă</option>
            <option value="land">Teren</option>
          </select>
